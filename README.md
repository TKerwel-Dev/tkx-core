body: |
  ...
  - Single World Enforcement
  - Strict Lifecycle State Control
  - Rendering Isolation via VisualSystem
  - Runtime-neutral UUID generation
  - Extensionless import policy
  - Integrity-verified architecture
  ...
  - Explicit Registration > Auto Wiring  
  - Architecture > Demo Effect  
  ...
  - Tags represent stable engine baselines.
